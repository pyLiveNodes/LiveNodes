...
class VtlnWrapper:
    ...
    def __init__(self, dictionary, modelMapper, scorer, hypoBeam, hypoTopN,
    ...
    def estimateParameter(self, references, mcfss):
        ...
        while (i < len(references)):
            ...
            logger.log(
                ...
                "utterance " + str(i) + " with beam factor " + str(beamFactor))
            ...
            beams = BioKIT.Beams(hypoBeam, hypoTopN, finalHypoBeam,
                                 finalHypoTopN, latticeBeam)

            sgh = BioKIT.SearchGraphHandler(self.__dictionary, tokenIds,
                                            fillWordId, self.__modelMapper,
                                            self.__scorer, beams,
                                            self.__tokenSequenceModelWeight,
                                            self.__tokenInsertionPenalty)
            ...
            for param in self.__parameter_range:
                ...
                warpedFeatureSequence = self.__preprocessingChain.execute(
                    mcfs, vtlnWarpingFactor=param)
            ...
            if not repeatUtterance:
                ...
                if not skipUtterance:
                    ...
                    for param in self.__parameter_range:
                        scoresByParam[param] = scoresByParam[
                            param] + currentScoresByParam[param]
