...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Client for simple job scheduler")
    parser.add_argument('host', help="host running the server")
    parser.add_argument('-p', '--port', help="server port (default 8888)",
    ...
    parser_set.add_argument('machines', nargs='+', help=("format is " +
